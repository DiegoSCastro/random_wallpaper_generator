...
/// Lü 3D attractor. Bridges Lorenz and Chen attractor families.
///   dx/dt = a*(y - x)
///   dy/dt = -x*z + c*y
///   dz/dt = x*y - b*z
/// Projects to XY plane.
class LuGenerator implements Generator {
  const LuGenerator();

  @override
  GeneratorParams get defaultParams => GeneratorParams.luDefault;
